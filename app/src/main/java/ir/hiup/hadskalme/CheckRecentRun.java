...
public class CheckRecentRun extends Service {
    ...
    public void onCreate() {
        ...
        String m2 = ir.hiup.hadskalme.Shared.read("m2", "null");

        // Are notifications enabled?
        // Is it time for a notification?
        if (Long.valueOf(m2) < System.currentTimeMillis() - delay)
            sendNotification();
    ...
    public void sendNotification() {
        ...
        Notification noti = new Notification.Builder(this)
                ...
                .setContentTitle("دلتنگتیم")
                .setContentText("خیلی وقته بهمون سر نزدیا!")
                .setDefaults(Notification.DEFAULT_ALL)
                .setSmallIcon(R.drawable.applogo)
                .setTicker("دلتنگتیم ، خیلی وقته بهمون سر نزدیا!")
