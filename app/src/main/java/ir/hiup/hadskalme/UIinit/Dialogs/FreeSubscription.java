...
public class FreeSubscription extends Dialog implements View.OnClickListener {
        private Activity c;
        public Dialog d;
        String text;

    public FreeSubscription(Activity a, String text) {
            super(a);
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setCancelable(true);
            setContentView(R.layout.freesubscription);
